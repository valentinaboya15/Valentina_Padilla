<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="container">
  <a class="navbar-brand main-title" href="/">Tienda Mascotas</a>
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="{{url('/presentacion/historia')}}">Historia</a>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="{{url('/perro/catalPerro')}}">Perros</a>
          <a class="dropdown-item" href="{{url('/gatos/catalGato')}}">Gatos</a>
